...
A mixed-effects logistic regression on all three experiments
...
showed no significant main effect of experiment or interaction between
experiment and any other variables, which suggests that children did not
perform more poorly when facial and prosodic cues were unavailable, and
they were able to make judgments based on linguistic cues alone.
Additionally, across all three experiments, children became better with
age in indicating that using ``can you please\textasciitilde{}'' was
polite (\(\beta\) = 0.42, \(p =\) 0.019).
